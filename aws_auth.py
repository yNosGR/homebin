...
idpentryurl = 'https://sso.leanlogistics.com:9031/idp/startSSO.ping?PartnerSpId=urn:amazon:webservices'
...
for saml2attribute in root.getiterator('{urn:oasis:names:tc:SAML:2.0:assertion}Attribute'):
    if (saml2attribute.get('Name') == 'https://aws.amazon.com/SAML/Attributes/Role'):
        for saml2attributevalue in saml2attribute.getiterator('{urn:oasis:names:tc:SAML:2.0:assertion}AttributeValue'):
